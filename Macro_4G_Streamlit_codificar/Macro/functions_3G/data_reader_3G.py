...
# 1.5. Lectura de RfBranch (Agregado para Sector_generator)
    ...
    other_sheets = ['IUB', 'SECTOR', 'RETPROFILE', 'ANTENNABRANCH', 'DOWNLINKBASEBANDPOOL', 'RBSLOCALCELL', 'CARRIER', 'SITECONFIGURATION', 'EQUIPMENT-CONFIGURATION', 'UTRANCELL', 'NODEBSECTORCARRIER', 'NODEBFUNCTION', 'IUBLINK', 'IUBDATASTREAMS', 'NODEBLOCALCELL', 'FEATURES', 'RACH', 'PCH', 'HSDSCH', 'FACH', 'EUL', 'E-FACH', 'UTRANRELATION', 'EUTRANFREQRELATION', 'EXTERNALEUTRANCELL', 'EUTRANCELLRELATION', 'MSCPARAMETER', 'TPADEVICE_RRUDEVICEGROUP', 'TXDEVICEGROUP', 'ANTFEEDERCABLE', 'SECTORANTENNA', 'IP', 'IPACCESSHOSTE', 'RNCFUNCTION', 'GIGABITETHERNET']
